...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // 6. Use the function that determines the radius of the earthquake marker 
  // based on its magnitude.
  
  
  // 7. Creating a GeoJSON layer with the retrieved data that adds a circle to the 
  // map sets the style of the circle, and displays the magnitude and location of 
